...
void trp_main(void)
{
	...
	mm_primary_init();
	print_info("finish mm primary init\n");
	allocator_init();
	print_info("finish allocator init\n");
	init_console();
	print_info("finish console init\n");
	init_granule();
	print_info("finish granule init\n");
	virt_primary_init();
	print_info("finish virt_primary init\n");
	rust_printf();
	print_info("finish rust_printf\n");
	rust_test_alloc();
	print_info("finish test alloc\n");
}
...
static trp_args_t * trp_asc_mark_realm(unsigned long long x1)
{
	...
	unsigned long ret;
	ret = trp_smc(set_smc_args(RMMD_GTSI_DELEGATE, x1,
						0UL, 0UL, 0UL, 0UL, 0UL, 0UL));	
	smc_granule_delegate(x1);

	return set_smc_args(RMMD_RMI_REQ_COMPLETE, ret,
			    0, 0, 0, 0, 0, 0);
}
...
static trp_args_t * trp_asc_mark_nonsecure(unsigned long long x1)
{
	...
	unsigned long ret;
	ret = trp_smc(set_smc_args(RMMD_GTSI_UNDELEGATE, x1, 0UL, 0UL, 0UL, 0UL, 0UL, 0UL));
 ...
 ******************************************************************************/
static trp_args_t * trp_realm_create(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_realm_create(x1, x2);
 ...
 ******************************************************************************/
static trp_args_t * trp_realm_destroy(unsigned long long x1)
{
	unsigned long ret;
	ret = smc_realm_destroy(x1);
 ...
 ******************************************************************************/
static trp_args_t * trp_realm_activate(unsigned long long x1)
{
	unsigned long ret;
	ret = smc_realm_activate(x1);
 ...
 ******************************************************************************/
static trp_args_t * trp_table_create(unsigned long long x1, unsigned long long x2, unsigned long long x3, unsigned long long x4)
{
	unsigned long ret;
	ret = smc_table_create(x1, x2, x3, x4);
 ...
 ******************************************************************************/
static trp_args_t * trp_table_destroy(unsigned long long x1, unsigned long long x2, unsigned long long x3, unsigned long long x4)
{
	unsigned long ret;
	ret = smc_table_destroy(x1, x2, x3, x4);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_map(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_data_map(x1, x2);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_unmap(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_data_unmap(x1, x2);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_create(unsigned long long x1, unsigned long long x2, unsigned long long x3, unsigned long long x4)
{
	unsigned long ret;
	ret = smc_data_create(x1, x2, x3, x4);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_destroy(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_data_destroy(x1, x2);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_create_unknown(unsigned long long x1, unsigned long long x2, unsigned long long x3)
{
	unsigned long ret;
	ret = smc_data_create_unknown(x1, x2, x3);
 ...
 ******************************************************************************/
static trp_args_t * trp_data_dispose(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_data_dispose(x1, x2);
 ...
 * Create an unknown data page and map to the rtt, before data_map
 ******************************************************************************/
static trp_args_t * trp_data_create_shared(unsigned long long x1, unsigned long long x2, unsigned long long x3)
{
	unsigned long ret;
	ret = smc_data_create_shared(x1, x2, x3);
	return set_smc_args(RMMD_RMI_REQ_COMPLETE, ret,
			    0, 0, 0, 0, 0, 0);
}
 ...
 ******************************************************************************/
static trp_args_t * trp_rec_create(unsigned long long x1, unsigned long long x2, unsigned long long x3, unsigned long long x4)
{
	unsigned long ret;
	ret = smc_rec_create(x1, x2, x3, x4);
 ...
 ******************************************************************************/
static trp_args_t * trp_rec_destroy(unsigned long long x1)
{
	unsigned long ret;
	ret = smc_rec_destroy(x1);
 ...
 * Run realm
 ******************************************************************************/
static trp_args_t * trp_rec_run(unsigned long long x1, unsigned long long x2)
{
	unsigned long ret;
	ret = smc_rec_run(x1, x2);
				...
				unsigned long long x4, unsigned long long x5)
{
	...
	case RMI_RMM_REALM_CREATE:
		return trp_realm_create(x1, x2);
	case RMI_RMM_REALM_DESTROY:
		return trp_realm_destroy(x1);
	case RMI_RMM_REALM_ACTIVATE:
		return trp_realm_activate(x1);
	case RMI_RMM_TABLE_CREATE:
		return trp_table_create(x1,x2,x3,x4);
	case RMI_RMM_TABLE_DESTROY:
		return trp_table_destroy(x1, x2, x3, x4);
	case RMI_RMM_DATA_MAP:
		return trp_data_map(x1, x2);
	case RMI_RMM_DATA_UNMAP:
		return trp_data_unmap(x1, x2);
	case RMI_RMM_DATA_CREATE:
		return trp_data_create(x1, x2, x3, x4);
	case RMI_RMM_DATA_DESTROY:
		return trp_data_destroy(x1, x2);
	...
	case RMI_RMM_REC_RUN:
		return trp_rec_run(x1, x2);
	case RMI_RMM_DATA_CREATE_UNKNOWN:
		return trp_data_create_unknown(x1, x2, x3);
	case RMI_RMM_DATA_DISPOSE:
		return trp_data_dispose(x1, x2);
	case RMI_RMM_MAP_NS:
		return trp_data_create_shared(x1, x2, x3);
	default:
